...
public class MessageAppDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MessageAppGlobalFeatureConfigurator.Configure();
        MessageAppModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MessageAppDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MessageAppResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MessageApp");

            options.DefaultResourceType = typeof(MessageAppResource);
        ...
        {
            options.MapCodeNamespace("MessageApp", typeof(MessageAppResource));
        });
    }
}
